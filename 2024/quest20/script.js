...
const run2 = map => {
    ...
    console.log('Since (see map layout) it is quite easy to cycle up into exactly needed alt close to the exit on our (forced) path, chances are the P2 answer is...');
    return 10000-altsDirs[0].alt+totalDist;
}
